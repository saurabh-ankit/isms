    ...
    <div class="chakra-responsive-layout">
        ...
        <div class="main-container">
            ...
            <div class="chakra-main">
                ...
                <!-- Main content -->
                <div class="content-area" style="padding: 1.5rem; min-height: calc(100vh - 10rem);">
        ...
        <!-- Footer -->
        <footer class="chakra-footer" style="width: 100%; background-color: white; padding: 1rem; text-align: center; border-top: 1px solid var(--chakra-colors-gray-200); margin-top: auto;">
            <!-- <p style="margin: 0; color: var(--chakra-colors-gray-600); font-size: 0.875rem;">
                &copy; 2025 <?php // echo $_settings->info('name') ?>
            </p> -->
            &copy; 2025 Inventory And Vendor Management
        </footer>
